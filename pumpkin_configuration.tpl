...
Meta.Description=Pumpkin is a blazingly fast Minecraft server implementation written in Rust.
Meta.OS=Windows, Linux
Meta.AarchSupport=Native
Meta.Arch=All
Meta.Author=PumpkinMC
Meta.URL=https://pumpkinmc.org/
Meta.DisplayImageSource=url:https://avatars.githubusercontent.com/u/144211181?s=200&v=4
...
Console.UserJoinRegex=^.+?\(\d+\) (?<username>.+?) joined the game$
Console.UserLeaveRegex=^.+?\(\d+\) (?<username>.+?) left the game$
